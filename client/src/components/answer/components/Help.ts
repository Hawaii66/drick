...
const PersonChallenges = [
  "Send a risky text to the last person you texted",
  ...
  "Scroll through your contacts and call the first person whose name starts with ‘J’",
  ...
  "Send a random emoji to the first person on your Snapchat list",
  "Describe your dream partner in three words",
  "Let the person next to you pick a word and you have to freestyle rap with it",
  ...
  "Take a selfie right now and send it to the 5th person in your recent texts",
  ...
  "Let the person next to you choose a new name for your phone’s contact in their phone",
  ...
  "Name one person in the group you’d date if you had to",
  ...
  "Whisper something to the person next to you and they have to say it out loud",
  ...
  "Let someone else in the group send an emoji to the last person you texted",
  ...
  "Try to guess what the person to your left is thinking",
...
const GroupChallenges = [
  ...
  "Go around and each person says their weirdest food combo",
  "Last person to touch their nose has to do 10 jumping jacks",
  "Everyone pick one person and say something nice about them",
  "Group votes on one person to send a random message to their last text",
  "Everyone take a sip if they’ve ever stalked an ex online",
  "Whoever has the lowest battery has to do a dare",
  "First person to laugh has to do an embarrassing dance",
  "Pick a word, and each person has to come up with a song lyric that has it",
  ...
  "Last person to say ‘not me’ has to do a TikTok dance",
  "Each person take turns saying a fun fact about themselves",
  ...
  "First person to blink in a staring contest has to tell a childhood story",
  ...
  "Each person say a random word, and the next person has to rhyme it",
  "Whoever has the most tabs open on their phone has to take a sip",
  "First person to check their phone has to do 20 squats",
  ...
  "First person to yawn has to do a silly dance",
  "Whoever has the messiest room right now has to take a dare",
  "Each person share the cringiest thing they’ve ever posted online",
  ...
  "Each person has to say one thing they’re bad at",
  "Everyone say their first ever email address (if you dare)",
  "First person to touch their phone has to send a random emoji to their crush",
  "Whoever can hold their breath the longest gets to dare someone else",
  "Each person say a word that describes the person to their right",
  "Whoever has the most unread emails has to tell the group a lie and a truth",
  "Everyone send their first Instagram DM to a random person in their contacts",
  "Whoever has the shortest nails has to do a silly impression",
  "Each person says one thing they’d do if they won the lottery",
  ...
  "Each person say one thing they would never do (but kinda wanna)",
  "Everyone turn their phones upside down, last person to do it takes a dare",
  ...
  "First person to sneeze gets to pick a new rule for the next round",
  "Go around and each person say a funny WiFi name they’ve seen",
  ...
  "Each person say one word to describe their day",
  "First person to check a notification has to post a random status update",
  ...
  "Each person has to say their most used emoji without showing it",
  "Whoever is the tallest in the group has to tell an embarrassing story",
  "First person to yawn has to compliment everyone in the group",
  ...
  "First person to say ‘I don’t know’ has to sing a random song",
  ...
  "First person to say ‘what’ has to do an accent challenge",
  "Whoever has the oldest unread text has to read it out loud",
  ...
  "First person to blink in a staring contest has to take a sip",
  ...
  "First person to laugh has to do a dare chosen by the group",
  "Whoever has the most exes has to tell a dating horror story",
  "First person to check their phone has to hand it over to someone else for the next round",
...
export const TruthStatements = [
  ...
  "Said ‘bye love you’ on accident to the wrong person",
...
export const LieStatements = [
  ...
  "Have never sent a text to the wrong person",
  ...
  "Once got a text from a famous person",
