...
function App() {
    ...
    return <div className="py-4">
        <h1 className="bg-clip-text bg-linear-to-tr from-[#f06a47] to-[#eaae13] py-4 font-bold text-transparent text-3xl text-center tracking-wider">
            drickspel.com
        </h1>

        <h2 className="font-bold text-2xl text-center">Välj Spel</h2>
        <GameSelectSearch>
